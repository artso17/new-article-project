...
const title=encodeURIComponent(document.getElementsByTagName('h2')[0].innerHTML)
const socialShare=document.getElementsByClassName('social-share')
const posttitle=encodeURIComponent('Ingin tahu kelanjutannya? Cek selengkapnya di Artsodevalog: ')
...
socialShare['whatsapp_share'].setAttribute('href',`https://api.whatsapp.com/send?text=${postUrl}`)
